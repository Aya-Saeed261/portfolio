...
const Project = ({ img, name, codeLink, liveLink, tags }) => {
  return (
    <div className="project-holder shadow">
      ...
      <div className="pb-3">
        <h2 className="fs-4 text-uppercase text-center">{name}</h2>
        <ul className="list-unstyled mb-0 d-flex justify-content-center gap-2 p-2">
          {tags.map((tag, indx) => (
            <li key={indx}>
